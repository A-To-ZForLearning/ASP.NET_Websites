...
<body>
    ...
    <customControls:Header runat="server" heading="Publisher List" />
        ...
        <p>
            <asp:DataList ID="DataList1" runat="server" DataKeyField="pub_id" DataSourceID="SqlDataSource1" Width="182px">
                <ItemTemplate>
                   
                    <!-- The sign # refers to the data binding expression for 
    ...
    <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:mybookstoreConnectionString2 %>" 
