...
<body>
    ...
    <p>
        <asp:DetailsView ID="DetailsView1" runat="server" AutoGenerateRows="False" 
            DataKeyNames="title_id" DataSourceID="SqlDataSource1" Height="282px" 
            Width="289px" DefaultMode="Insert" CellPadding="4" ForeColor="#333333" 
            ...
            <Fields>
                ...
                <asp:TemplateField HeaderText="PubDate">
                    <EditItemTemplate>
                        ...
                        <asp:TextBox ID="pubdate" runat="server" Text="<%#Bind('pupdate') %>"></asp:TextBox>
