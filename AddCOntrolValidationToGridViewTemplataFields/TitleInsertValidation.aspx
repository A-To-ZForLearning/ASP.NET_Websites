            ...
            <Fields>
                ...
                <asp:TemplateField HeaderText="Price">
                    <EditItemTemplate>
                        ...
                        <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" ControlToValidate="price" ErrorMessage="Please Enter a Price" Display="Dynamic" CssClass="validationError"></asp:RequiredFieldValidator>
                        <asp:RangeValidator ID="RangeValidator1" runat="server" ControlToValidate="price" ErrorMessage="Price must be between 100-2500" MaximumValue="2500" MinimumValue="100" Type="Double" Display="Dynamic" CssClass="validationError"></asp:RangeValidator>
                    </EditItemTemplate>
                </asp:TemplateField>
                ...
                <asp:TemplateField HeaderText="PubDate">
                    <EditItemTemplate>
                        <asp:TextBox ID="pubdate" runat="server"
                            Text="<%# Bind('pubdate') %>" />
                         <asp:RangeValidator ID="RangeValidator2" runat="server" ControlToValidate="pubdate" ErrorMessage="Please Enter a vlaid Date" MaximumValue="1/12/2050" MinimumValue="1/1/1999" Type="Date" Display="Dynamic" CssClass="validationError"></asp:RangeValidator>
                    </EditItemTemplate>                
                </asp:TemplateField>
