...
<body>
    ...
    <p>
        <asp:DetailsView ID="DetailsView1" runat="server" AutoGenerateRows="False" 
            ...
            OnItemCommand="DetailView_ItemCommand" EnableModelValidation="True">
    ...
    <p>
         <!-- To provide the value of the colums "au_id" to the page 
                We have to define the tag SelectParameters-->
