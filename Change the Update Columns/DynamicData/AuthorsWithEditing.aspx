...
<body>
    ...
    <p>
        <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" 
            ...
            EmptyDataText="There are no data records to display." Width="847px" 
            AllowPaging="True" CellPadding="4" ForeColor="#333333" GridLines="None" 
            PageSize="5" EnableModelValidation="True" Height="324px">
            ...
            <Columns>
                ...
                <asp:BoundField DataField="au_fname" HeaderText="First Name" SortExpression="au_fname" ReadOnly="True" />
